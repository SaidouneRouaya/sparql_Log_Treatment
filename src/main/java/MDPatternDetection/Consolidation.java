...
public class Consolidation {
    ...
    public static HashMap<String, Model> consolidate(Collection<Model> modelArrayList) {
        ...
        HashMap<String, Model> resultsHashMap = TdbOperation.unpersistModelsMap(TdbOperation.originalDataSetStringModel);
    ...
    public static void toStringModelHashMap(Collection<Model> modelArrayList) {
        ...
        while (it.hasNext()) {
            ...
            if (num == 10000) {
                ...
                TdbOperation.persistNonAnnotated(modelHashMap, TdbOperation.originalDataSetStringModel);
                modelHashMap.clear();
                num = 0;
            }
